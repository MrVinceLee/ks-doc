...
1）Linux来说无论有几个分区，分给哪一目录使用，它归根结底就只有一个根目录，一个独立且唯一的文件结构，Linux中每个分区都是用组成整个文件系统的一部分。

2）Linux采用了一种叫做”载入“处理方法，它的整个文件系统中包含了一整套的文件和目录，且将一个分区和一个目录联系起来。这时要载入的一个分区将使它的存储空间在一个目录下获得。

3）示意图

![image-20230528182523710](https://cdn.jsdelivr.net/gh/mrvincelee/myimages@main/imgs/202305281825839.png)

##### 12.1.2.硬盘说明

1）Linux硬盘分IDE硬盘和SCSI硬盘，目前基本上是SCSI硬盘

2）对于IDE硬盘，驱动器标识符为”hd~“，

其中”hd“表明分区所在设备的类型，这里是指IDE硬盘了。
...
![image-20230528183542388](https://cdn.jsdelivr.net/gh/mrvincelee/myimages@main/imgs/202305281835461.png)

##### 12.1.3.查看所有设备挂载情况

命令：lsblk 或者 lsblk -f

![image-20230528183714719](https://cdn.jsdelivr.net/gh/mrvincelee/myimages@main/imgs/202305281837773.png)

#### 12.2.挂载的经典案例

##### 12.2.1.说明：

下面我们以增加一块硬盘为例来熟悉下硬盘的相关指令和深入理解磁盘分区、挂载、卸载的概念。
...
![image-20230529123444709](https://cdn.jsdelivr.net/gh/mrvincelee/myimages@main/imgs/202305291234774.png)
...
![image-20230529124220914](https://cdn.jsdelivr.net/gh/mrvincelee/myimages@main/imgs/202305291242971.png)
...
![image-20230529124721623](https://cdn.jsdelivr.net/gh/mrvincelee/myimages@main/imgs/202305291247696.png)
